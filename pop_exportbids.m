...
if nargin < 3 && ~ischar(STUDY)
    ...
    uilist = { ...
        ...
        { 'Style', 'text', 'string', 'README (short introduction to the experiment):' }, ...
        { 'Style', 'edit', 'string', '' 'tag' 'readme' 'HorizontalAlignment' 'left' 'max' 3 }, ...
        { 'Style', 'text', 'string', 'CHANGES compared to previous release (if any):' }, ...
        { 'Style', 'edit', 'string', '' 'tag' 'changes'  'HorizontalAlignment' 'left' 'max' 3   }, ...
        { 'Style', 'pushbutton', 'string', 'Edit task info' 'tag' 'task' 'callback' cb_task }, ...
        { 'Style', 'pushbutton', 'string', 'Edit EEG info' 'tag' 'task' 'callback' cb_eeg }, ...
    ...
    relSize = 0.7;
    geometry = { [1] [1] [1-relSize relSize*0.8 relSize*0.2] [1-relSize relSize] [1-relSize relSize] [1-relSize relSize] [1-relSize relSize] [1] [1] [1] [1] [1 1 1 1] };
    geomvert =   [1  0.2 1         1           1           1           1           1   3   1   3  1];
