...
function strout = bids_template_README()
    ...
    '\n' ...
    'The test below is a template. The researcher has decided to not include a README file. If you are the researcher, please update the file content accordingly.' ...
    '\n' ...
